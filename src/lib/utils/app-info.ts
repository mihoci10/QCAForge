...
import { arch, locale, platform, version, hostname } from '@tauri-apps/plugin-os';
...
export async function getAppInfo(): Promise<AppInfo> {
    ...
    return {
        name: "QCAForge",
        author: "Miha Krajnc",
        description: "QCA Forge is a powerful tool for designing and simulating Quantum-dot Cellular Automata (QCA) circuits. It provides an intuitive interface for creating complex QCA designs and analyzing their behavior through advanced simulation capabilities.",
        license: "MIT",
        buildInfo,
        systemInfo
    }
