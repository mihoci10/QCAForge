<script lang="ts">
    import { createCellArchitecture, getDotRadius, type CellArchitecture } from "$lib/CellArchitecture";
...
<BaseModal bind:open={isOpen} type='confirm' {applyCallback}>
	...
	<div class="flex flex-col gap-2">
		<div class="flex flex-col gap-1.5">
			...
			<Input name='cell_architecture_name' value={cell_architecture.name}/>
		</div>
		<div class="flex flex-col gap-1.5">
			<Label for='cell_architecture_dot_count'>Number of dots</Label>
			<Input name='cell_architecture_dot_count' 
		...
		<div class="flex flex-col gap-1.5">
			...
			<div class="flex items-center gap-2">
				<Input name='cell_architecture_dot_diameter' 
						type='number' inputmode='decimal' min='0' step='1e-3'
						value={cell_architecture.dot_diameter}/>
				<span>nm</span>
			</div>
		</div>
		<div class="flex flex-col gap-1.5">
			<Label for='cell_architecture_position_radius'>Dot position radius</Label>
			<div class="flex items-center gap-2">
				<Input name='cell_architecture_position_radius' 
						type='number' inputmode='decimal' min='0' step='1e-3'
		...
		<div class="flex flex-col gap-1.5">
			...
			<div class="flex items-center gap-2">
				<Input name='cell_architecture_side_length' 
						type='number' inputmode='decimal' min='0' step='1e-3'
