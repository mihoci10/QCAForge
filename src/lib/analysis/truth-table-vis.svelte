<script lang='ts'>
    ...
    function getInputCellIndecies() : CellIndex[] {
        return inputs.filter(input => input.type === InputType.CELL)
    ...
    function calculate(){
        ...
        const params = {
            ...
            cellClockDelay: Object.fromEntries([...props.cellClockDelay.entries()]),
        ...
        invoke("calculate_truth_table", params)
            .then((result) => {
                ...
                const max_len = Math.max(...truth_table.map(row => row[1].length));
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <div class="flex items-center gap-1">
                                    ...
                                    <InputUI
                                        ...
                                        value={props.cellClockDelay.get(input.index.toString()) || 0}
